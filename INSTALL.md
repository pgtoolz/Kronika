...
Download the [1.2.4 release archive](https://github.com/pgtoolz/Kronika/releases/tag/v1.2.4)
for your architecture. The commands below use x86-64. For ARM64, set
`target=aarch64-unknown-linux-musl`.

```sh
target=x86_64-unknown-linux-musl
archive="kronika-1.2.4-$target.tar.gz"
curl -fLO "https://github.com/pgtoolz/Kronika/releases/download/v1.2.4/$archive"
tar -xzf "$archive"
cd "${archive%.tar.gz}"
```
