...
Для режима сбора только PostgreSQL и TLS, описанных в этой версии, собирайте
этот каталог исходников. При отдельном клонировании выберите версию этих
инструкций командой `git checkout FULL_COMMIT` перед сборкой. Опубликованный
тег `v1.0.1` не содержит этих возможностей; он нужен только для сборки того релиза.
