...
В режиме `KRONIKA_COLLECTOR_MODE=postgresql` сбор Linux отключён. В режиме `local` записи обычной машины/VM не содержат ресурсов cgroup. В контейнере сборщик поднимается от своей группы до самого верхнего видимого и читаемого предка в подходящем монтировании cgroup v2. Соседние группы не обходятся; наличие процессов непосредственно в родителе не требуется. См. [группы ресурсов контейнера](#container-cgroups).
