...
В режиме `--mode postgresql` сбор Linux отключён. В режиме `local` сборщик записывает все видимые и доступные каталоги cgroup v2 на машине, VM и в контейнере. Нынешние показатели ресурсов контейнера относятся к самому верхнему доступному предку группы сборщика. См. [сбор cgroup](#container-cgroups).
