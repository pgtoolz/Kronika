...
Process resource details require explicit recorded sharing with Linux processes in the same segment. For PostgreSQL-only, container and older recordings, matching PIDs alone do not establish this link. SQL progress and Activity remain available.
