...
thread_local! {
    pub(super) static TEST_SWITCHES: std::cell::Cell<usize> = const { std::cell::Cell::new(0) };
    pub(super) static TEST_QUERIES: std::cell::Cell<usize> = const { std::cell::Cell::new(0) };
    pub(super) static TEST_READS: std::cell::RefCell<std::collections::VecDeque<IoRead>> =
