...
use crate::acquisition::probe::SERVER_PROBE_SQL;
...
pub(super) fn serve_enumeration_denied(listener: &TcpListener) {
    ...
    loop {
        ...
        match tag[0] {
            ...
            b'B' | b'D' | b'E' => {}
            b'S' => {
                if sql == crate::activity::activity_query(crate::activity::ActivityVersion::V3)
                    || sql == crate::locks::locks_query(crate::locks::LocksVersion::V2)
                {
